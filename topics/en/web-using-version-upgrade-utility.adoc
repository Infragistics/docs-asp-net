...
[NOTE]
====
Version Utility 11.1 is designed to upgrade projects to {ProductName} 11.1 or higher. If you need to upgrade to one of the previous versions of {ProductName} (ex. 10.3) you should use the Version Utility that was shipped with that volume.
====
