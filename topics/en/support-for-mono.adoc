...
We now support integrating {ProductName} controls into Mono-based ASP.NET applications. For more information on getting started with Mono, see link:http://www.mono-project.com/Start[Start].
...
|{ProductName}
|{ProductName} v10.1 CLR 3.5 or later
