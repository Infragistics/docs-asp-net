...
Starting in the 2006 Volume 3 release, the {ProductName} product provides a set of assemblies marked with Microsoft® .NET Framework's AllowPartiallyTrustedcallersAttribute (APTCA) attribute. These specially-marked assemblies are capable of running in a partially trusted environment.
