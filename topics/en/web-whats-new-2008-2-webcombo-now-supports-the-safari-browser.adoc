...
Starting in {ProductName} 2008 Volume 2, the WebCombo™ control supports the Apple® Safari™ Web Browser. The rich features of WebCombo that were previously unavailable in Safari are now implemented for the browser.