...
The following table summarizes the known issues and limitations of the {ProductName}® 2013.1 release. Detailed explanations and possible workarounds are provided for some of the issues follow the summary table.
