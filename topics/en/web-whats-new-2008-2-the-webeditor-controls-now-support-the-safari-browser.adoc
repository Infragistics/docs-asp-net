...
Starting in {ProductName} 2008 Volume 2, all of the web editors fully support the Apple® Safari™ Web Browser. The expansive and varied features of these editors are now fully available in the Safari browser.