...
This topic provides an overview of the new functionalities introduced with the {ProductName} 12.1®

== New Features

=== New features overview

The following table summarizes the new features of the {ProductName} 12.1 Additional details are available after following the summary table.
