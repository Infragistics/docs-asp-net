...
The {ProductName} 2009 Volume 2 release includes a collection of new controls built on the {ProductName} AJAX framework.
...
The WebCurrencyEditor™ control is a new addition to the expanding list of {ProductName} AJAX controls. The WebCurrencyEditor control’s new design makes it an efficient and scalable editor control, with native AJAX capabilities.

Like all {ProductName} AJAX controls, WebCurrencyEditor seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebCurrencyEditor control by leveraging your existing style sheets.
...
* *Native AJAX Support* -- Because the {ProductName} AJAX controls are built on top of the Microsoft® ASP.NET AJAX Extensions, most WebCurrencyEditor functionalities are executed using AJAX, eliminating full page postbacks.
...
The WebDatePicker™ control is a new addition to the expanding list of {ProductName} AJAX controls. The WebDatePicker control’s new design makes it an efficient and scalable editor control, with native AJAX capabilities.

Like all {ProductName} AJAX controls, WebDatePicker seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebDatePicker control by leveraging your existing style sheets.
...
* *CenturyTreshold* -- Autofills year field to the 20th or 21st century, if only 1 or 2 digits are entered by the end-user.
* *Native AJAX Support* -- Because the {ProductName} AJAX controls are built on top of the Microsoft® ASP.NET AJAX Extensions, most WebDatePicker functionalities are executed using AJAX, eliminating full page postbacks.
...
The WebDateTimeEditor™ control is a new addition to the expanding list of {ProductName} AJAX controls. The WebDateTimeEditor control’s new design makes it an efficient and scalable editor control, with native AJAX capabilities.

Like all {ProductName} AJAX controls, WebDateTimeEditor seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebDateTimeEditor control by leveraging your existing style sheets.
...
* *SelectionOnFocus* -- You can set different selection types for whenever entering edit mode.
* *Culture* -- You can set the CultureInfo object used by the control for localized formatting.
* *Native AJAX Support* -- Because the {ProductName} AJAX controls are built on top of the Microsoft® ASP.NET AJAX Extensions, most WebDateTimeEditor functionalities are executed using AJAX, eliminating full page postbacks.
...
The WebMaskEditor™ control is a new addition to the expanding list of {ProductName} AJAX controls. The WebMaskEditor control’s new design makes it an efficient and scalable editor control, with native AJAX capabilities.

Like all {ProductName} AJAX controls, WebMaskEditor seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebMaskEditor control by leveraging your existing style sheets.
...
* *Native AJAX Support* -- Because the {ProductName} AJAX controls are built on top of the Microsoft® ASP.NET AJAX Extensions, most WebMaskEditor functionalities are executed using AJAX, eliminating full page postbacks.
...
The WebMonthCalendar™ control is a new addition to the expanding list of {ProductName} AJAX controls. The WebMonthCalendar control’s new design makes it an efficient and scalable calendar control, with native AJAX capabilities.

Like all {ProductName} AJAX controls, WebMonthCalendar seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebMonthCalendar control by leveraging your existing style sheets.
...
* *Native AJAX Support* -- Because the {ProductName} AJAX controls are built on top of the Microsoft® ASP.NET AJAX Extensions, most WebMonthCalendar functionalities are executed using AJAX, eliminating full page postbacks.
...
The WebNumericEditor™ control is a new addition to the expanding list of {ProductName} AJAX controls. The WebNumericEditor control’s new design makes it an efficient and scalable editor control, with native AJAX capabilities.

Like all {ProductName} AJAX controls, WebNumericEditor seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebNumericEditor control by leveraging your existing style sheets.
...
* *MinDecimalPlaces* -- Allows you to set the minimum number of decimal places to be displayed when the control loses focus.
* *Native AJAX Support* -- Because the {ProductName} AJAX controls are built on top of the Microsoft® ASP.NET AJAX Extensions, most WebNumericEditor functionalities are executed using AJAX, eliminating full page postbacks.
...
The WebPercentEditor™ control is a new addition to the expanding list of {ProductName} AJAX controls. The WebPercentEditor control’s new design makes it an efficient and scalable editor control, with native AJAX capabilities.

Like all {ProductName} AJAX controls, WebPercentEditor seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebPercentEditor control by leveraging your existing style sheets.
...
* *MinDecimalPlaces* -- Allows you to set the minimum number of decimal places to be displayed when the control loses focus.
* *SelectionOnFocus* -- You can set different selection types for whenever entering edit mode.
* *Native AJAX Support* -- Because the {ProductName} AJAX controls are built on top of the Microsoft® ASP.NET AJAX Extensions, most WebPercentEditor functionalities are executed using AJAX, eliminating full page postbacks.
...
The WebTextEditor™ control is a new addition to the expanding list of {ProductName} AJAX controls. The WebTextEditor control’s new design makes it an efficient and scalable editor control, with native AJAX capabilities.

Like all {ProductName} AJAX controls, WebTextEditor seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebTextEditor control by leveraging your existing style sheets.
...
* *Standard Validators support* -- Supports ASP.NET validator controls.
* *SelectionOnFocus* -- You can set different selection types for whenever entering edit mode.
* *Native AJAX Support* -- Because the {ProductName} AJAX controls are built on top of the Microsoft® ASP.NET AJAX Extensions, most WebTextEditor functionalities are executed using AJAX, eliminating full page postbacks.
