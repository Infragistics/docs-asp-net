...
Starting in {ProductName} 2008 Volume 2, the WebGrid™ control supports the Apple® Safari™ Web Browser. WebGrid's rich features that were previously unavailable in Safari are now implemented for the web browser.