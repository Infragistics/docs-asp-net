...
The {ProductName} 2011 Volume 1 release introduces the following new features:
...
In {ProductName} 2011 Volume 1, some of the new capabilities of the WebDataGrid™ and WebHierarchicalDataGrid™ controls are related the new column types of these controls:
