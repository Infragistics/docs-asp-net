...
In the 2005 Volume 1 release, the WebMisc assembly was added to the list of assemblies already in {ProductName}. Included in the WebMisc assembly were two new controls: the WebPanel™ control and the WebGroupBox™ control. This procedure involves the WebGroupBox control.
