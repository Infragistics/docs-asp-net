...
This topic provides an overview of the new functionalities and components introduced with the {ProductName} 11.2.
...
The new {ProductName} Volume 2 is now available for tablet platforms. The {ProductName} now controls support touch events and the controls are redesigned to fit the common tablet-based sizes.
