...
In {ProductName} 2009.2, the stored procedures for the SQL data base have changed. If you are using data from the WebSchedule2.sql data file prior to 2009.2, you need to update the stored procedures.

{ProductName} 2009.2 ships with the following 2 SQL scripts:
