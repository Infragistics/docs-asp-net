...
Applications which load a preset dynamically at run time to restore the look and feel of the {ProductName} controls to a user's custom preferences will need to deploy those preset files in their Web application's directory.
