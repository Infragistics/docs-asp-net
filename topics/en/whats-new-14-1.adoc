...
|There is a new, modern default theme for the {ProductName} controls.
...
In order to keep up with the modern look-and-feel of web applications, a new, modern default theme has been made available for all {ProductName} controls. The old default theme has been renamed to IG2007.
