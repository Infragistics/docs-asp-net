...
The WebRating control functions as an editor for your data; based on interaction with the end user, the control records the information. WebRating is available as an editor provider ,so you can use it as an embeddable editor in {ProductName} grid controls.
