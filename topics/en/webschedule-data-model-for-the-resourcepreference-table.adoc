...
Columns marked with an asterisk ($$*$$) in the following table are new or have been modified for the WebSchedule Data Model in {ProductName} 2006 Volume 2 and later.
