...
This section offers a listing of all of our ASP.NET assemblies. It also provides you with useful links about {ProductName} APTCA Assemblies and how to add an assembly to your project.
...
This is an essential section in the help, and the one that you will most likely refer to most often. This section contains information on each {ProductName} control.
...
This section provides you with information on how to upgrade an existing project that uses {ProductName}