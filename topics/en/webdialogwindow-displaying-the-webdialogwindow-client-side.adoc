...
[NOTE]
====
If you are following this guide with a Web Project instead of a Web Site, you should also set the WebDialogWindow's "ClientIDMode" option to "Static" to guarantee the JavaScript functions in this example will work correctly.
====