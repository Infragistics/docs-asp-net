...
[start=1]
. As all {ProductName} AJAX controls, WebExplorerBar creates a client-side object with the ClientID of the control. To obtain a reference, use the following code:
