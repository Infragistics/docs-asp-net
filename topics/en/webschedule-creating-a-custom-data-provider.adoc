...
[NOTE]
====
This walkthrough uses the default WebSchedule database connection, which refers to a Microsoft Jet database file installed with {ProductName}. For information, see link:webschedule-connecting-webschedule-to-a-database-in-visual-studio-2005.html[Connecting WebSchedule to a Database in Visual Studio 2005].
====
