...
The {ProductName} controls include a rich client-side object model, allowing you to manipulate how users interact with controls.
...
[NOTE]
====
This procedure is similar for all {ProductName} controls built on the '{ProductName} AJAX Framework'.
====
