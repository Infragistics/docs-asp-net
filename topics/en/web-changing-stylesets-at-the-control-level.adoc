...
When Application Styling is enabled, it is designed to style all {ProductName} controls on the form with the same StyleSet. However there may be cases when there is a specific area on your form that you don't want to be styled by the StyleSet.
