...
= Touch Support in {ProductName}

== Topic Overview

== Purpose

This topic explains the touch support of {ProductName} controls and details the changes and limitations of the controls’ features with regards to this support.
...
* <<touch_support_overview,{ProductName} {ProductVersion} Touch Support Overview>>
...
{ProductName} {ProductVersion} pack expands the supported platforms to cover tablets as well. Now you can use the same functionalities that ASP.NET controls have, except drag-and-drop.
...
== {ProductName} {ProductVersion} Touch Support Overview

== Supported controls

The controls from the {ProductName} suit are available for tablet platforms. In this document we will make review for the following controls, that have been modified to fully support tablet platforms:
