...
The {ProductName} 2008 Volume 3 release includes the long-awaited WebDataGrid™ control built on the {ProductName} AJAX framework.

== New WebDataGrid Control

The WebDataGrid™ control is a new addition to the expanding list of {ProductName} AJAX controls. WebDataGrid’s new design makes it an efficient and scalable grid control, with native AJAX capabilities.
