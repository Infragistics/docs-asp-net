...
{ProductName} Application Styling offers project templates in Microsoft® Visual Studio® .NET 2005. You can use these project templates to create an empty Web site with Application Styling enabled.
...
[start=2]
. An HTML page opens, listing all the starter kits and project templates included with {ProductName}. At the bottom of the page are links for the Application Styling project templates.
[start=3]
