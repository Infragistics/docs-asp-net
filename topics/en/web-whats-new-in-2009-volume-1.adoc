...
The {ProductName} 2009 Volume 1 release includes a collection of new controls built on the {ProductName} AJAX framework along with the new Infragistics Drag and Drop Framework.
...
The WebDataMenu™ control is a new addition to the expanding list of {ProductName} AJAX controls. WebDataMenu’s new design makes it an efficient and scalable multi-level, hierarchical Menu or pop-up context Menu control, with native AJAX capabilities.

Like all {ProductName} AJAX controls, WebDataMenu seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebDataMenu control by leveraging your existing style sheets.
...
* *Native AJAX Support* - Because the {ProductName} AJAX controls are built on top of the Microsoft® ASP.NET AJAX Extensions, most of WebDataMenu’s functionalities are executed using AJAX, eliminating full page postbacks.
...
The WebDataTree™ control is a new addition to the expanding list of {ProductName} AJAX controls. WebDataTree’s new design makes it an efficient and scalable multi-level, hierarchical Tree control. WebDataTree can be used to display your hierarchical data model or it can also be used as a navigation control. Many possibilities exist when integrating WebDataTree into your applications.

Like all {ProductName} AJAX controls, WebDataTree seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebDataTree control by leveraging your existing style sheets.
...
The WebDropDown™ control is a new addition to the expanding list of {ProductName} AJAX controls. WebDropDown’s new design makes it an efficient and scalable list control, with native AJAX capabilities.

Like all {ProductName} AJAX controls, WebDropDown seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebDropDown control by leveraging your existing style sheets.
...
* *Native AJAX Support* - Because the {ProductName} AJAX controls are built on top of the Microsoft® ASP.NET AJAX Extensions, most of WebDropDown’s functionalities are executed using AJAX, eliminating full page postbacks.
...
The WebProgressBar™ control is a new addition to the expanding list of {ProductName} AJAX controls. WebProgressBar’s new design makes it an efficient and scalable progress indicator control. WebProgressBar can be used to update the end-user with the current progress of an operation as well as provide a visual animated cue to indicate an AJAX postback is currently in progress.

Like all {ProductName} AJAX controls, WebProgressBar seamlessly integrates into the Infragistics® Application Styling framework. With CSS based properties, you can manually customize the WebProgressBar control by leveraging your existing style sheets.
