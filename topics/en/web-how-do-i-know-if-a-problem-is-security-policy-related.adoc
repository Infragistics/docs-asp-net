...
When the same code works for you using the non-APTCA {ProductName} assemblies in a full-trust environment, the problem is related to the security policy granted to your Web application.
