...
[NOTE]
====
These WebHtmlEditor toolbar buttons are supported in all versions of Internet Explorer but note that in the Microsoft Edge browser the paste access has been revoked. The copy and cut buttons are now supported in Chrome as well as in Mozilla Firefox from version 41 and above.
====
