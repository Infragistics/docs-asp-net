...
The application programming interface (API) is the foundation for all of our ASP.NET controls and components. The API Reference Guide offers a definitive listing of all the {ProductName} classes, enumerations, interfaces, and delegates -- organized by ASP.NET assembly.
