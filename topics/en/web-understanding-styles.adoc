...
The {ProductName} elements offer several powerful, yet flexible means of adding styles to the controls.
...
Every style object exposed by a {ProductName} control permits the use of Cascading StyleSheets to specify formatting.
