...
|<<http-error,IIS7 以後を使用する場合、ツールボックスから WebUpload/WebCaptcha を追加すると、HTTP エラー 500.22 が発生します。>>
...
=== IIS7 以後を使用する場合、ツールボックスから WebUpload/WebCaptcha を追加すると、HTTP エラー 500.22 が発生します。
