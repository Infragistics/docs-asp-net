...
= ゲージ デザイナを使用して複雑な WebGauge を作成（1/5）
...
[start=5]
. link:webgauge-properties-panel.html[[プロパティ] パネル]で、 link:webgauge-appearance-tab.html[[外観] タブ]をクリックします。 link:webgauge-brush-pane.html[[ブラシ] ペイン]で、プロパティを以下のとおり指定したブラシ エレメントを追加します。

** link:webgauge-apply-the-multi-stop-radial-gradient-brush-element-using-the-gauge-designer.html[マルチストップ放射型グラデーション ブラシ エレメント]
...
[start=8]
. [外観] タブの link:webgauge-stroke-pane.html[[ストローク] ペイン]で、以下のプロパティを設定します。
...
[start=14]
. [プロパティ] パネルで、 link:webgauge-labels-layout-tab.html[[ラベル レイアウト] タブ]をクリックします。 link:webgauge-orientation-pane.html[[方向] ペイン]で、以下のプロパティを設定します。
...
[start=16]
. link:webgauge-labels-appearance-tab.html[[ラベル外観] タブ]をクリックします。[ブラシ] ペインで、以下のプロパティを設定します。
...
[start=19]
. [プロパティ] パネルで、 link:webgauge-tickmark-layout-tab.html[[目盛レイアウト] タブ]をクリックします。 link:webgauge-tickmark-extent-pane.html[[範囲] ペイン]で、以下のプロパティを設定します。
...
[start=32]
. [プロパティ] パネルで、 link:webgauge-needle-marker-layout-tab.html[[針マーカー レイアウト] タブ]をクリックします。 link:webgauge-widths-and-extents-pane.html[[幅と範囲] ペイン]で、以下のプロパティを設定します。
...
[start=33]
. [針マーカー レイアウト] タブの link:webgauge-value-and-units.html[[値と単位] ペイン]で、以下のプロパティを設定します。
...
[start=37]
. link:webgauge-back-anchor-layout-tab.html[[アンカー レイアウト] タブ]の link:webgauge-radius-pane.html[[半径] ペイン]で、以下のプロパティを設定します。
...
[start=42]
. link:webgauge-range-layout-tab.html[[レンジ レイアウト] タブ]の link:webgauge-value-pane.html[[値] ペイン]で、以下のプロパティを設定します。

** 開始 -- 180.00
** 終了 -- 360.00

[start=43]
. [レンジ レイアウト] タブの link:webgauge-extent-pane.html[[範囲] ペイン]で、以下のプロパティを設定します。
...
link:webgauge-creating-a-complex-webgauge-using-the-webgauge-designer-part-2-of-5.html[ゲージ デザイナを使用して複雑な WebGauge を作成（2/5）]