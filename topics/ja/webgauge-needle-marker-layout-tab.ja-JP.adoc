...
Gauge コントロールの  pick:[asp-net="link:{ApiPlatform}webui.ultrawebgauge{ApiVersion}~infragistics.ultragauge.resources.radialgaugeneedle.html[Needle Marker]"]  プロパティは、スケール上の特定の値を指し示すポインタとして表示されます。たとえば、時計を表すラジアル ゲージを作成している場合には、時計の針を表示するために針マーカーを使用します。
...
* link:webgauge-widths-and-extents-pane.html[幅と範囲]
* link:webgauge-value-and-units.html[値と単位]
